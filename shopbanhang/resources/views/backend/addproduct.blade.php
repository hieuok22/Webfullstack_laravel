							...
							<div class="row" style="margin-bottom:40px">
								<div class="col-xs-8">
									...
									<div class="form-group" >
					                    ...
					                    <img id="avatar" class="thumbnail" width="300px" src="http://localhost/bwd/shopbanhang/public/backend/img/2.png">
									...
									<div class="form-group" >
										<label>Miêu tả</label>
										<textarea class="edit1" id="" required name="description"></textarea>
									</div>
									<div class="form-group" >
