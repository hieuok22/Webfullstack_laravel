							...
							<div class="row" style="margin-bottom:40px">
								<div class="col-xs-8">
									...
									<div class="form-group" >
										...
										class="form-control" value="{{$product->prod_price}}">
									</div>
									<div class="form-group" >
									...
									<div class="form-group" >
										...
										<input required type="number" name="numbers" class="form-control"
										value="{{$product->prod_numbers}}">
									</div>
									<div class="form-group" >
										<label>Màu sắc</label>
										<input required type="text" name="accessories" 
										class="form-control" value="{{$product->prod_accessories}}">
									</div>
									...
									<div class="form-group" >
										<label>Miêu tả</label>
										<textarea class="edit1" required name="description"
									...
									<div class="form-group" >
										...
										<select required name="cate" class="form-control">
											...
											<option value="{{$cate->cate_id}}" @if($product->prod_cate == $cate->cate_id) 
												selected @endif>{{$cate->cate_name}}</option>
											@endforeach
					                    </select>
									</div>
									<div class="form-group" >
