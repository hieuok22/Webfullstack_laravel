							...
							<form method="post">
								<table class="table table-bordered .table-responsive text-center">
									...
									<tr>
										...
										<td id="namesp" name="namesp" >{{$item->name}}</td>
										<td>
										...
										<td><span class="quantity">{{number_format($item->price*$item->qty,0,',','.')}} VNĐ</span></td>
								...
								<div class="row" id="total-price">
									<div class="col-md-6 col-sm-12 col-xs-12">						
										Tổng thanh toán: <span name="total" class="total-price" value="1">{{$total}} VNĐ</span>																			
									</div>
									<div class="col-md-6 col-sm-12 col-xs-12">
										<a href="http://localhost/bwd/shopbanhang/" class="my-btn btn">Mua tiếp</a>
										<a href="{{asset('cart/show')}}" class="my-btn btn">Cập nhật</a>
										<a href="{{asset('cart/delete/all')}}" class="">Xóa giỏ hàng</a>
									</div>
								</div>
								{{csrf_field()}}
							</form>             	                	
