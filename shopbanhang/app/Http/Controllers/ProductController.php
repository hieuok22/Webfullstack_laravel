...
class ProductController extends Controller
{
    public function getProduct() {
        $data['productlist'] = DB::table('v_products')->join('v_categories'
        ,'v_products.prod_cate','=','v_categories.cate_id')->orderBy('prod_id','desc')->get();
    ...
    public function postAddProduct(AddProductRequest $request) {
        ...
        $product -> prod_numbers = $request->numbers;
    ...
    public function postEditProduct(Request $request,$id) {
        ...
        $arr['prod_numbers'] = $request->numbers;
